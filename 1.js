...
class OrderTracker {
  ...
  // Приватне статичне поле для збереження списку замовлень, початкове значення пустий масив
  static #orders = [];

  /**
   * Статичний метод create використовується для створення єдиного екземпляра класу
   * Якщо екземпляр класу вже існує, повертається цей екземпляр, інакше створюється новий
   */
  static create() {
   ...
   * @param {string} item - Нове замовлення
   */
  static add(item) {
   ...
   * Повертає список всіх замовлень, збережених в класі
   * @returns {Array} - Масив замовлень
   */
  static get() {
